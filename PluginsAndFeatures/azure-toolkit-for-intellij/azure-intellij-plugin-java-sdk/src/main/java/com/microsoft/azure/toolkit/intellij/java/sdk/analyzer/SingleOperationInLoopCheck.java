...
public class SingleOperationInLoopCheck extends LocalInspectionTool {
    ...
    static class SingleOperationInLoopVisitor extends JavaElementVisitor {
         ...
         *
         * @param holder The holder for the problems found
         * @param isOnTheFly Whether the inspection is running on the fly. If true, the inspection is running as you
         * type.
         */
        ...
        /**
         * Get the body of the loop statement. The body of the loop statement is the statement that is executed in the
         * loop.
         *
            ...
            if (expression instanceof PsiMethodCallExpression) {
                ...
                if (isAzureTextAnalyticsClientOperation((PsiMethodCallExpression) expression)) {
                    ...
                    holder.registerProblem(expression,
                        (RULE_CONFIG.getAntiPatternMessage() + methodName + "Batch"));
                }
            }
        }
        ...
        private void isDeclarationAzureClientOperation(PsiDeclarationStatement statement) {
            ...
            for (PsiElement element : statement.getDeclaredElements()) {
                ...
                if (isAzureTextAnalyticsClientOperation((PsiMethodCallExpression) initializer)) {
                    // get the method name
                    String methodName =
                        ((PsiMethodCallExpression) initializer).getMethodExpression().getReferenceName();
        ...
        /**
         * Check if the method call is an Azure client operation. Check the containing class of the method call and see
         * if it is part of the Azure SDK. If the class is part of the Azure SDK, increment the count of Azure client
         * operations.
         *
        ...
        private static boolean isAzureTextAnalyticsClientOperation(PsiMethodCallExpression methodCall) {
            ...
            if (containingClass != null) {
                ...
                if (className != null && SCOPE_TO_CHECK.stream().anyMatch(className::startsWith)) {
                    if (RULE_CONFIG.getUsagesToCheck()
                        .contains((methodCall.getMethodExpression().getReferenceName()) + "Batch")) {
                        return true;
                    }
                }
            }
